...
#ifndef MAPSFORGE_CIRCLE_H
#define MAPSFORGE_CIRCLE_H
 ...
 */
class Circle : public RenderInstruction
{
public:
	Circle(const QBrush &fill, const QPen &stroke, float radius, float strokeWidth, bool scaleRadius, int level);
