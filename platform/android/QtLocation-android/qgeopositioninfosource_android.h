...
public:
    ...
    explicit QGeoPositionInfoSourceAndroid(QObject *parent = 0);
    ...
    void dataUpdated(const QGeoPositionInfo &data);
...
public:
    static QList<QGeoPositionInfoSourceAndroid *> allSources;
};
